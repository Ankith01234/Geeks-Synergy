...
//
//     final homeScreenData = homeScreenDataFromJson(jsonString);

import 'dart:convert';

HomeScreenData homeScreenDataFromJson(String str) => HomeScreenData.fromJson(json.decode(str));

String homeScreenDataToJson(HomeScreenData data) => json.encode(data.toJson());
